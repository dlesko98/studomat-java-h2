...
public class AdminMenuBarController {
    ...
    public void showExamsScreen() {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("adminInsertNewExam.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load(), 900, 600);
        } catch (IOException e) {
    ...
    public void showInsertNewSubjectScreen() {

        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("adminInsertNewSubject.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load(), 900, 600);
        } catch (IOException e) {
    ...
    public void showAllStudentsScreen() {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("adminSearchStudents.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load(), 900, 600);
        } catch (IOException e) {
    ...
    public void showAllSubjectsScreen() {

        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("adminSearchSubjects.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load(), 900, 600);
        } catch (IOException e) {
    ...
    public void showAllExamsScreen() {

        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("adminSearchExams.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load(), 900, 600);
        } catch (IOException e) {
